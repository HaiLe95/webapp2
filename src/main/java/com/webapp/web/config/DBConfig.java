...
/** This class is CONFIG class that uses Hibernate as main and only DBConnector
 *  all configs in @Value are already written in resources/application.properties
 */

@Configuration
@EnableTransactionManagement
@EnableJpaRepositories("com.webapp.web.dao")
public class DBConfig {
    ...
    /**
     *
     * @param factoryBean - No worries if it's red, IDK why, but it works(lol)
     * @return
     */
    ...
    /**
     *
     * @param dataSource - wait for updates...
     * @param vendorAdapter - wait for updates...
     * @return
     */
